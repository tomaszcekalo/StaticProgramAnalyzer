...
namespace StaticProgramAnalyzer.Tests
{
    ...
    public class FirstSecondThirdPattern
    {
        ...
        {
            //Act
            Assert.AreEqual(processor.ProcessQuery("while w;", "Select w pattern w(\"x\",_)"),"12");
        }
        ...
        public void PatternTestWhileAll()
        {
            ...
            Assert.AreEqual(result,"12, 14, 19, 33, 35, 37");
        }
        ...
        {
            //Act
            Assert.AreEqual(processor.ProcessQuery("if ifstm;", "Select ifstm pattern ifstm(\"k\",_,_)"), "16");
        }
        ...
        {
            //Act
            Assert.AreEqual(processor.ProcessQuery("assign a;", "Select a pattern a(\"x\",_)"), "1, 5, 15, 20, 24, 29, 34");
        }
        [TestMethod]
        public void PatternTestAssignExactVariableNotExactExpr()
        {
            //Act
            Assert.AreEqual(processor.ProcessQuery("assign a;", "Select a pattern a(\"y\",_\"x+1\"_)"), "3, 8, 26");
        }
        ...
        {
            //Act
            Assert.AreEqual(processor.ProcessQuery("assign a;", "Select a pattern a(\"y\",\"x+1\")"), "8");
        }
        ...
        {
            //Act
            Assert.AreEqual(processor.ProcessQuery("if ifstm;", "Select ifstm pattern ifstm(_,_,_)"), "16, 23");
        }
        ...
        public void PatternTestAssignAll()
        {
            ...
            Assert.AreEqual(result, "1, 2, 3, 5, 6, 7, 8, 9, 10, 11, 13, 15, 17, 18, 20, 22, 24, 25, 26, 27, 28, 29, 30, 31, 32, 34, 36, 38");
        }
        ...
        {
            //Act
            Assert.AreEqual(processor.ProcessQuery("assign a;", "Select a pattern a(_,_\"x+1\"_)"), "3, 8, 10, 11, 24, 26, 31");
        }
        ...
        {
            //Act
            Assert.AreEqual(processor.ProcessQuery("assign a;", "Select a pattern a(_,\"x+1\")"), "8, 10, 24, 31");
        ...
        {
            //Act
            Assert.AreEqual(processor.ProcessQuery("assign a;", "Select a pattern a(\"y\",_\"x+1\"_) and pattern a(\"y\",_\"7\"_)"), "26");
        }
        ...
        {
            Assert.AreEqual(processor.ProcessQuery("assign a; while w", "Select a such that Parent(w, a) and pattern a(\"x\",_\"x+y\"_) and pattern w(_,_)"), "15, 34");
        }
        /// <summary>
        ...
        {
            Assert.AreEqual(processor.ProcessQuery("assign a; while w", "Select w such that Parent(w, a) and pattern a(\"x\",_\"x+y\"_) and pattern w(_,_)"), "14, 33");
        }
        /// <summary>
        ...
        {
            Assert.AreEqual(processor.ProcessQuery("assign a; while w", "Select a such that Parent(w, a) and pattern a(_,_\"x+y\"_) and pattern w(_,_)"), "15, 34, 36");
        }
        /// <summary>
        ...
        {
            Assert.AreEqual(processor.ProcessQuery("assign a; while w", "Select a such that Parent(w, a) and pattern a(_,_) and pattern w(\"k\",_)"), "15, 36, 38");
        }
        /// <summary>
        ...
        {
            Assert.AreEqual(processor.ProcessQuery("assign a; while w", "Select a such that Parent(w, a) and pattern a(_,_\"x+y\"_) and pattern w(\"k\",_)"), "15, 36");
        }
        /// <summary>
        ...
        {
            Assert.AreEqual(processor.ProcessQuery("assign a; while w", "Select a such that Parent(w, a) and pattern a(_,\"x+y\") and pattern w(\"k\",_)"), "15");
        }
        /// <summary>
